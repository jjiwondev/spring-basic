...
public class ApplicationContextExtendsFindTest {
    ...
    @Test
    @DisplayName("부모타입으로 조회시, 자식이 둘 이상 있으면, 이름을 이용하면 된다")
    void findBeanByTypeUsingName(){
        DiscountPolicy fixDiscountPolicy = ac.getBean("fixDiscountPolicy", DiscountPolicy.class);
        Assertions.assertThat(fixDiscountPolicy).isInstanceOf(DiscountPolicy.class);
    }

    @Test
    @DisplayName("특정하위타입으로 조회(추천x)")
